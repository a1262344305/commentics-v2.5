...
define('CMTX_TEXT_PRIVACY', 'Прочетох и разбрах <a href="' . cmtx_commentics_url() . 'agreement/bulgarian/privacy_policy.html" class="cmtx_privacy_link" title="Разгледай Условията за защита на личните данни" target="_blank" rel="nofollow">Условията за защита на личните данни</a>.');

/* Text displayed after terms checkbox */
define('CMTX_TEXT_TERMS', 'Прочетох и се съгласявам с <a href="' . cmtx_commentics_url() . 'agreement/bulgarian/terms_and_conditions.html" class="cmtx_terms_link" title="Разгледай другите условия" target="_blank" rel="nofollow">другите условия</a>.');
