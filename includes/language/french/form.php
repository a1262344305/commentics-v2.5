...
define('CMTX_TEXT_PRIVACY', 'J\'ai lu et j\'ai compris la <a href="' . cmtx_commentics_url() . 'agreement/french/privacy_policy.html" class="cmtx_privacy_link" title="Lire politique de confidentialité" target="_blank" rel="nofollow">politique de confidentialité</a>.');

/* Text displayed after terms checkbox */
define('CMTX_TEXT_TERMS', 'J\'ai lu et j\'approuve les <a href="' . cmtx_commentics_url() . 'agreement/french/terms_and_conditions.html" class="cmtx_terms_link" title="Lire termes et conditions" target="_blank" rel="nofollow">termes et conditions</a>.');
