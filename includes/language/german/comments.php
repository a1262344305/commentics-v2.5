...
/* Sort By */
define('CMTX_SORT_TEXT', 'Sortieren Sie die Kommentare:');
define('CMTX_SORT_TITLE', 'Sortieren Sie die Kommentare');
...
define('CMTX_FLAG_DIALOG_CONTENT', 'Sie sind sicher, dass Sie diesen Kommentar melden?');
