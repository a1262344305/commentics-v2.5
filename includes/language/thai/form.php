...
define('CMTX_TEXT_PRIVACY', 'ฉันได้อ่านและเข้าใจเป็นอย่างดีแล้วเกี่ยวกับ <a href="' . cmtx_commentics_url() . 'agreement/thai/privacy_policy.html" class="cmtx_privacy_link" title="View privacy policy" target="_blank" rel="nofollow">นโยบายส่วนบุคคล</a>.');

/* Text displayed after terms checkbox */
define('CMTX_TEXT_TERMS', 'ฉันได้อ่านและยอมรับตาม <a href="' . cmtx_commentics_url() . 'agreement/thai/terms_and_conditions.html" class="cmtx_terms_link" title="View terms and conditions" target="_blank" rel="nofollow">ข้อตกลงและเงื่อนไข</a>.');
