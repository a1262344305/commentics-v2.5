...
$cmtx_ratings = '<select name="cmtx_rating" class="cmtx_rating_field" title="' . cmtx_define(CMTX_TITLE_RATING) . '">
...
$cmtx_rated = '<select name="cmtx_rating" disabled="disabled" class="cmtx_rating_field" title="' . cmtx_define(CMTX_HAS_RATED) . '">
